...
def create_job(payload: JobCreate, service: JobService = Depends(service_dependency)) -> JobRead:
...
def confirm_job(job_id: str, service: JobService = Depends(service_dependency)) -> ConfirmationRead:
    try:
